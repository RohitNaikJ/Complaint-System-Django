...
urlpatterns = [
    ...
    url(r'^createNewComplaint/(?P<createComplaint_title>[A-Za-z+]+)/(?P<createComplaint_description>[A-Za-z0-9(%20)]+)/(?P<creatComplaint_roomNo>[A-Za-z0-9_-]+)/(?P<createComplaint_origin>[A-Za-z]+)/(?P<createComplaint_levelOfComplaint>[A-Za-z]+)/(?P<createComplaint_category>[A-Za-z]+)/(?P<createComplaint_status_AS>[A-Za-z]+)/(?P<createComplaint_status_RU>[A-Za-z]+)/(?P<createComplaint_username>[A-Za-z0-9])/$', views.createNewComplaint, name = "Create New Complaint"),
    ...
    url(r'^upVoteComplaint/(?P<complaintID>\d+)/(?P<vote>(1|-1))/$', views.upDownVoteComplaint, name='UpVote or DownVote the Complaint'),
    url(r'^testingJSONRequest/$', views.returnJSON, name='Testing JSON Request'),
]